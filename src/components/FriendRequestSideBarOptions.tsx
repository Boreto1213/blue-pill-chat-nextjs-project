...
> = ({ initialUnseenRequestsCount, sessionId}) => {
    const [unseenRequestsCount, setUnseenRequestsCount] = useState<number>(initialUnseenRequestsCount);
  return (
    <Link
      href="/dashboard/requests"
      className="text-gray-700 hover:text-indigo-700 hover:bg-gray-50 group flex items-center rounded-md p-2 gap-3 text-sm leading-6 font-semibold"
    >
